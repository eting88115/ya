...
<%
	...
	String sql = "SELECT * FROM leelab WHERE memberId ='" + request.getParameter("memberId")+"'";
  ...
  <!-- //Header -->
 <form action="update.jsp?memberId=<%=request.getParameter("memberId")%>" method="post" name="form" >
...
//點選提交按鈕觸發下面的函式
function pic(){  
	document.form.action="UploadFile.jsp";
	...
	document.form.submit();
          ...
          <h3 class="title-big"><%=rs.getString("memberName") %></h3>
            <span class="text mb-2"><%=rs.getString("position") %></span>
