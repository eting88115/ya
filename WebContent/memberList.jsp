...
<%	
	...
	String sql = "SELECT leelab.*,position.position as positionName FROM leelab left join position on leelab.positionID=position.positionID ORDER BY positionID,joinYearMonth ";
          ...
          <div class="item">
            <div class="d-grid team-info">
              <div class="column position-relative">
                <a href="member.jsp?memberId=<%=rs.getString("memberId")%>"><img src="<%=rs.getString("pic") %>" alt="" class="img-fluid rounded team-image"></a>
              </div>
              <div class="column">
